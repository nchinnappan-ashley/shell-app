module.exports = [
"[project]/.next-internal/server/app/api/rag/ingest/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/rag/chunk.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/rag/ingest/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$chunk$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/rag/chunk.ts [app-route] (ecmascript)");
    ...
    try {
        ...
        for (const url of urls){
            try {
                ...
                const chunks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$chunk$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chunkText"])(text, url, undefined, 1200);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSparseDocuments"])(chunks);
                results.push({
                    url,
        ...
        if (dir) {
            try {
                ...
                for (const d of docs){
                    const chunks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$chunk$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chunkText"])(d.text, d.url, d.title, 1200);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSparseDocuments"])(chunks);
                    results.push({
                        url: d.url,
                        chunks: chunks.length
        ...
        for (const fp of files){
            try {
                ...
                if (one) {
                    const chunks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$chunk$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chunkText"])(one.text, one.url, one.title, 1200);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSparseDocuments"])(chunks);
                    results.push({
                        url: one.url,
                        chunks: chunks.length
                    ...
                    const chunks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$chunk$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chunkText"])(text, fileUrl, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].basename(fp), 1200);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rag$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSparseDocuments"])(chunks);
                    results.push({
                        url: fileUrl,
                        chunks: chunks.length
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97d073d8._.js.map