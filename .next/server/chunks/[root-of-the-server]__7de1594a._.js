module.exports = [
"[project]/shell-app/.next-internal/server/app/api/rag/query/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/shell-app/src/app/api/rag/query/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const topSentences = Math.min(Math.max(parseInt(body?.topSentences || '4', 10) || 4, 1), 8);
        if (!query) return __TURBOPACK__imported__module__$5b$project$5d2f$shell$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Provide { query: string }'
        }, {
            status: 400
        });
        // Expand candidate set, then re-rank to avoid Ashley Direct when not requested
        const candidates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shell$2d$app$2f$src$2f$lib$2f$rag$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchSparse"])(query, Math.max(topK * 3, topK));
        ...
        if (isMerger) {
            ...
            if (mergerOnly.length) {
                scored.splice(0, scored.length, ...mergerOnly);
            }
        }
        ...
        if (isWhen) {
            ...
            if (filtered.length) {
                scored.splice(0, scored.length, ...filtered);
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7de1594a._.js.map